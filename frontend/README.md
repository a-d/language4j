...
api.exercises.generateTextCompletion(topic, count)
api.exercises.generateDragDrop(topic, count)
api.exercises.generateTranslation(topic, count)
api.exercises.evaluate(exercise, userResponse, expected)
api.speech.synthesize(text, languageCode, slow?)
