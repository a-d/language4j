...
const translations = {
    en: {
        ...
        'exercises.listeningComprehension': 'Listening Comprehension',
        'exercises.listeningComprehensionDesc': 'Listen to stories and answer questions',
        'exercises.lcInstructions': 'Listen to the story, then answer the true/false questions below. The text is hidden by default to encourage active listening.',
        'exercises.lcPlayStory': 'Play Story',
        'exercises.lcPause': 'Pause',
        'exercises.lcResume': 'Resume',
        'exercises.lcPlayAgain': 'Play Again',
        'exercises.lcReplay': 'Replay',
        'exercises.lcLoading': 'Loading...',
        'exercises.lcShowStoryText': 'Show Story Text',
        'exercises.lcHideStoryText': 'Hide Story Text',
        'exercises.lcShowTranslation': 'Show Translation',
        'exercises.lcHideTranslation': 'Hide Translation',
        'exercises.lcTranslation': 'Translation',
        'exercises.lcTrueOrFalse': 'True or False?',
        'exercises.lcAnswered': 'answered',
        'exercises.lcTrue': 'True',
        'exercises.lcFalse': 'False',
        'exercises.lcCorrect': 'Correct!',
        'exercises.lcStatementTrue': 'The statement is TRUE',
        'exercises.lcStatementFalse': 'The statement is FALSE',
        'exercises.lcListenAgain': 'Listen Again',
        'exercises.lcPerfect': 'Perfect! Excellent listening comprehension!',
        'exercises.lcGreat': 'Great job! You understood most of the story.',
        'exercises.lcGood': 'Good effort! Try listening again to catch more details.',
        'exercises.lcKeepPracticing': 'Keep practicing! Listen to the story again and review the explanations.',
        'exercises.exit': '✕ Exit',
        'exercises.done': 'Done',
    ...
    de: {
        ...
        'exercises.listeningComprehension': 'Hörverstehen',
        'exercises.listeningComprehensionDesc': 'Geschichten hören und Fragen beantworten',
        'exercises.lcInstructions': 'Höre dir die Geschichte an und beantworte dann die Richtig/Falsch-Fragen. Der Text ist standardmäßig ausgeblendet, um aktives Zuhören zu fördern.',
        'exercises.lcPlayStory': 'Geschichte abspielen',
        'exercises.lcPause': 'Pause',
        'exercises.lcResume': 'Fortsetzen',
        'exercises.lcPlayAgain': 'Nochmal abspielen',
        'exercises.lcReplay': 'Wiederholen',
        'exercises.lcLoading': 'Lädt...',
        'exercises.lcShowStoryText': 'Text anzeigen',
        'exercises.lcHideStoryText': 'Text verbergen',
        'exercises.lcShowTranslation': 'Übersetzung anzeigen',
        'exercises.lcHideTranslation': 'Übersetzung verbergen',
        'exercises.lcTranslation': 'Übersetzung',
        'exercises.lcTrueOrFalse': 'Richtig oder Falsch?',
        'exercises.lcAnswered': 'beantwortet',
        'exercises.lcTrue': 'Richtig',
        'exercises.lcFalse': 'Falsch',
        'exercises.lcCorrect': 'Richtig!',
        'exercises.lcStatementTrue': 'Die Aussage ist RICHTIG',
        'exercises.lcStatementFalse': 'Die Aussage ist FALSCH',
        'exercises.lcListenAgain': 'Nochmal anhören',
        'exercises.lcPerfect': 'Perfekt! Ausgezeichnetes Hörverständnis!',
        'exercises.lcGreat': 'Gut gemacht! Du hast den größten Teil der Geschichte verstanden.',
        'exercises.lcGood': 'Guter Versuch! Höre nochmal zu, um mehr Details zu erfassen.',
        'exercises.lcKeepPracticing': 'Weiter üben! Höre die Geschichte nochmal und überprüfe die Erklärungen.',
